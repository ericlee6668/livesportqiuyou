...
public class NetworkUtil {
    ...
    public static NetworkUtil.netType getAPNType(Context context) {
        ...
        if (networkInfo == null) {
            ...
            if (nType == 0) {
                return networkInfo.getExtraInfo().toLowerCase().equals("cmnet") ? NetworkUtil.netType.CMNET : NetworkUtil.netType.CMWAP;
            } else {
                return nType == 1 ? NetworkUtil.netType.wifi : NetworkUtil.netType.noneNet;
            }
        }
    }
