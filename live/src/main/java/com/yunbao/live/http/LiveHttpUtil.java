...
public class LiveHttpUtil {
    ...
    public static void getLiveInfo(String liveUid, HttpCallback callback) {
        HttpClient.getInstance().get("Live.getLiveInfoV2", LiveHttpConsts.GET_LIVE_INFO)
                .params("liveuid", liveUid)
                .execute(callback);
    }
     ...
     * 用于 LOL比赛数据查询
     */
    public static void getMatchData(String match_id, int index, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject("Match.GetMatchData", LiveHttpConsts.GET_MATCH_DATA)
     ...
     * 用于 LOL比赛数据查询
     */
    public static void getMatchIndex(String match_id, int boardNum, int handicap, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_MATCH_INDEX, LiveHttpConsts.GET_MATCH_INDEX)
                .params("match_id", match_id) //比赛ID
                .params("board_num", boardNum) //第几局,0为全局
                .params("handicap", handicap)//0为早盘指数1为滚球指数
                .execute(callback);
    }
     ...
     * LOL比赛分析查询
     */
    public static void getLOLMatchListByAnalysis(String match_id, int range_type, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject("Match.GetMatchAnalysis", LiveHttpConsts.GET_LOL_MATCH_LIST_BY_ANALYSIS)
                .params("match_id", match_id)
     ...
     * 用于LOL比赛选手查询
     */
    public static void getLOLMatchPlayer(String match_id, int range_type, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_LOL_MATCH_PLAYER, LiveHttpConsts.GET_LOL_MATCH_PLAYER)
                .params("match_id", match_id)
                .params("range_type", range_type)
                .execute(callback);
    }
     ...
     * LOL比赛阵容
     */
    public static void getLOLBattleView(String match_id, int range_type, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_LOL_BATTLE_OUTLINE, LiveHttpConsts.GET_LOL_MATCH_PLAYER)
                .params("match_id", match_id)
                .params("range_type", range_type)//默认返回10场数据，0：最近5场比赛；1:最近10场比赛。统计场数不满5/10场，则有多少场统计多少场
                .execute(callback);
    }
     ...
     * 用于主播推荐直播
     */
    public static void getLOLRandomRecommend(String liveuid, String order, int page, int limit, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_LOL_RANDOM_RECOMMEND, LiveHttpConsts.GET_LOL_RANDOM_RECOMMEND)
                .params("liveuid", liveuid)
                .params("order", order)
                .params("limit", limit)
                .params("p", page)
     ...
     * 用于主播推荐直播
     */
    public static void getRecommendList(int page, int limit, HttpCallback callback) {
        HttpClient.getInstance().get(LiveHttpConsts.GET_LOL_RANDOM_RECOMMEND, LiveHttpConsts.GET_LOL_RANDOM_RECOMMEND)
                .params("limit", limit)
                .params("p", page)
                .execute(callback);
    }
     ...
     * 首页直播
     */
    public static void getHot(int page, int limit, HttpCallback callback) {
        HttpClient.getInstance().get(LiveHttpConsts.GET_HOT, LiveHttpConsts.GET_HOT)
                .params("limit", limit)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", page)
    ...
    public static void SubscribeAnchor(String touid, String type, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_SUBSCRIBE_ANCHOR, LiveHttpConsts.GET_SUBSCRIBE_ANCHOR)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
                .params("type", type)
     ...
     * @param callback
     */
    public static void getMatchInfo(String mMatchId, HttpCallbackObject callback) {
        HttpClient.getInstance().getDataObject(LiveHttpConsts.GET_MATCH_INFO, LiveHttpConsts.GET_MATCH_INFO)
     ...
     * @param callback
     */
    public static void getWatermark(HttpCallback callback) {
        HttpClient.getInstance().get(LiveHttpConsts.GET_WATER_MARK, LiveHttpConsts.GET_WATER_MARK)
                .params("device", 2)
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void leaveRoom(String stream, HttpCallback callback) {
        HttpClient.getInstance().get(LiveHttpConsts.LEAVE_ROOM, LiveHttpConsts.LEAVE_ROOM)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("device", 1)
     ...
     * @param callback
     */
    public static void getLiveSportsList(int limit, int classId, HttpCallback callback) {
        HttpClient.getInstance().getSports(LiveHttpConsts.LIVE_RECOMMEND, LiveHttpConsts.LIVE_RECOMMEND)
                .params("limit", limit)
                .params("class_id", "")
                .execute(callback);
    }
     ...
     *
     */
    public static void getRelatedLive(boolean isFootball, String matchId, V2Callback<List<MatchLiveBean>> callback) {
        String url = isFootball ? LiveHttpConsts.FOOTBALL_RELATED_LIVE : LiveHttpConsts.BASKETBALL_RELATED_LIVE;
        GetRequest request = HttpClient.getInstance().getV2Request(url, url);
        request.params("matchId", matchId);
        request.execute(callback);
    }

    public static void getFooBallMatch(String id, V2Callback<MatchBean> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.GET_FOOTBALL_MATCH, LiveHttpConsts.GET_FOOTBALL_MATCH);
        request.params("matchId", id);
        request.execute(callback);
    }

    public static void getBasketBallMatch(String id, V2Callback<MatchBean> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.GET_BASKETBALL_MATCH, LiveHttpConsts.GET_BASKETBALL_MATCH);
        request.params("matchId", id);
        request.execute(callback);
    }

    public static void getLiveInfoContact(String liveuid, String stream, HttpCallback callback) {
        HttpClient.getInstance().get(LiveHttpConsts.GET_LIVE_INFO_CONTACT, LiveHttpConsts.GET_LIVE_INFO_CONTACT)
                .params("liveuid", liveuid)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
     ...
     * 获取足球比赛对战双方情报
     *
     * @param isFootball 是否是足球比赛
     * @param matchId    比赛id
     * @param callback   数据回调
     */
    public static void getIntelligence(boolean isFootball, String matchId, V2Callback<GameIntelligence> callback) {
        String url = isFootball ? LiveHttpConsts.FOOTBALL_INTELLIGENCE : LiveHttpConsts.BASKETBALL_INTELLIGENCE;
        GetRequest request = HttpClient.getInstance().getV2Request(url, url);
        request.params("matchId", matchId);
        request.execute(callback);
    }
     ...
     * @param callback 数据回调
     */
    public static void getFootballLineUp(String matchId, V2Callback<FootballLineup> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.FOOTBALL_LINE_UP, LiveHttpConsts.FOOTBALL_LINE_UP);
        request.params("matchId", matchId);
        request.execute(callback);
    }
     ...
     * @param callback 数据回调
     */
    public static void getFootballLiveData(String matchId, V2Callback<FootballHistory> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.FOOTBALL_LIVE_URL, LiveHttpConsts.FOOTBALL_LIVE_URL);
        request.params("matchId", matchId);
        request.execute(callback);
    }
     ...
     * @param callback 数据回调
     */
    public static void getFootballAnalysis(String matchId, V2Callback<MatchAnalysis> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.FOOTBALL_MATCH_ANALYSIS, LiveHttpConsts.FOOTBALL_MATCH_ANALYSIS);
        request.params("matchId", matchId);
        request.execute(callback);
    }
     ...
     * @param callback 数据回调
     */
    public static void getMatchIndex(long matchId, boolean football, V2Callback<GameOpening> callback) {
        String url = football ? LiveHttpConsts.FOOTBALL_MATCH_INDEX : LiveHttpConsts.BASKETBALL_MATCH_INDEX;
        GetRequest request = HttpClient.getInstance().getV2Request(url, url);
        request.params("matchId", matchId);
        request.execute(callback);
    }

    public static void getBasketballLineUp(String matchId, V2Callback<BasketballLineup> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.BASKETBALL_LINEUP, LiveHttpConsts.BASKETBALL_LINEUP);
        request.params("matchId", matchId);
        request.execute(callback);
    }

    public static void getBasketMatchAnalysis(String matchId, V2Callback<FightHistory> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.BASKETBALL_ANALYSIS, LiveHttpConsts.BASKETBALL_ANALYSIS);
        request.params("matchId", matchId);
        request.execute(callback);
    }

    public static void basketballLive(String matchId, V2Callback<BasketballLive> callback) {
        GetRequest request = HttpClient.getInstance().getV2Request(LiveHttpConsts.BASKETBALL_MATCH_LIVE, LiveHttpConsts.BASKETBALL_MATCH_LIVE);
        request.params("matchId", matchId);
        request.execute(callback);
    }
}
