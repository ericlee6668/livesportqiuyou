...
//        list2.add(saveBean);
        ...
        switch (bean.getType()) {
            case Constants.LINK://复制链接
                if (onItemClickListener != null) {
                    onItemClickListener.copyLink();
                } else if (mContext instanceof AbsVideoPlayActivity) {
            ...
            default:
                if (onItemClickListener != null) {
                    onItemClickListener.shareVideoPage(bean.getType());
                } else if (mContext instanceof AbsVideoPlayActivity) {
    ...
    public interface OnItemClickListener {
        ...
        void shareVideoPage(String type);
    }
