...
public class VideoHttpUtil {
    ...
    public static void getHomeVideoList(int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.GetVideoList", VideoHttpConsts.GET_HOME_VIDEO_LIST)
    ...
    public static void getHomeVideoClassList(int videoClassId, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getClassVideo", VideoHttpConsts.GET_HOME_VIDEO_CLASS_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void setVideoLike(String tag, String videoid, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.AddLike", tag)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getVideoCommentList(String videoid, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.GetComments", VideoHttpConsts.GET_VIDEO_COMMENT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoid)
                .params("p", p)
    ...
    public static void setCommentLike(String commentid, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.addCommentLike", VideoHttpConsts.SET_COMMENT_LIKE)
    ...
    public static void setComment(String toUid, String videoId, String content, String commentId, String parentId, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.setComment", VideoHttpConsts.SET_COMMENT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", toUid)
                .params("videoid", videoId)
    ...
    public static void getCommentReply(String commentid, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getReplys", VideoHttpConsts.GET_COMMENT_REPLY)
                .params("commentid", commentid)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getMusicClassList(HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.classify_list", VideoHttpConsts.GET_MUSIC_CLASS_LIST)
                .execute(callback);
    }
    ...
    public static void getHotMusicList(int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.hotLists", VideoHttpConsts.GET_HOT_MUSIC_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void setMusicCollect(int muiscId, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.collectMusic", VideoHttpConsts.SET_MUSIC_COLLECT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getMusicCollectList(int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.getCollectMusicLists", VideoHttpConsts.GET_MUSIC_COLLECT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void getMusicList(String classId, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.music_list", VideoHttpConsts.GET_MUSIC_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void videoSearchMusic(String key, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Music.searchMusic", VideoHttpConsts.VIDEO_SEARCH_MUSIC)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("key", key)
                .params("p", p)
    ...
    public static void getQiNiuToken(HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getQiniuToken", VideoHttpConsts.GET_QI_NIU_TOKEN)
                .execute(callback);
    }
    ...
    public static void saveUploadVideoInfo(
        ...
        HttpClient.getInstance().getVideo("Video.setVideo", VideoHttpConsts.SAVE_UPLOAD_VIDEO_INFO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getHomeVideo(String toUid, int p, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getHomeVideo", VideoHttpConsts.GET_HOME_VIDEO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", toUid)
                .params("p", p)
    ...
    public static void getVideoReportList(HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getReportContentlist", VideoHttpConsts.GET_VIDEO_REPORT_LIST)
                .execute(callback);
    }
    ...
    public static void videoReport(String videoId, String reportId, String content, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.report", VideoHttpConsts.VIDEO_REPORT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoId)
    ...
    public static void videoDelete(String videoid, HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.del", VideoHttpConsts.VIDEO_DELETE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoid)
                .execute(callback);
    ...
    public static void setVideoShare(String videoid, HttpCallback callback) {
        ...
        String s = MD5Util.getMD5((TextUtils.isEmpty(uid) ? "0" : uid) + "-" + videoid + "-" + VIDEO_SALT);
        HttpClient.getInstance().getVideo("Video.addShare", VideoHttpConsts.SET_VIDEO_SHARE)
                .params("uid", TextUtils.isEmpty(uid) ? "0" : uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoid)
                .params("random_str", s)
                .execute(callback);
    ...
    public static void getConcatGoods(HttpCallback callback) {
        HttpClient.getInstance().getVideo("Video.getCon", VideoHttpConsts.GET_CONCAT_GOODS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void videoWatchStart(String videoUid, String videoId) {
        ...
        HttpClient.getInstance().getVideo("Video.addView", VideoHttpConsts.VIDEO_WATCH_START)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoId)
                .params("random_str", s)
    ...
    public static void videoWatchEnd(String videoUid, String videoId) {
        ...
        String s = MD5Util.getMD5(uid + "-" + videoId + "-" + VIDEO_SALT);
        HttpClient.getInstance().getVideo("Video.setConversion", VideoHttpConsts.VIDEO_WATCH_END)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("videoid", videoId)
                .params("random_str", s)
