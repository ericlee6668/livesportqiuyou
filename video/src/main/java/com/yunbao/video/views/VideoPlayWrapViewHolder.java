...
import com.yunbao.video.dialog.VideoCommentDialog;
...
public class VideoPlayWrapViewHolder extends AbsVideoPlayHolder implements View.OnClickListener {
    ...
    private void clickLike() {
        if (mVideoBean == null || TextUtils.isEmpty(CommonAppConfig.getInstance().getUid())) {
            //没有登陆，进入登陆
    ...
    private void clickComment() {
        ...
        if (mContext instanceof AbsVideoPlayActivity) {
            ...
            fragment.setVideoInfo(mVideoBean.getId(), mVideoBean.getUid());
    ...
    private void clickShare() {
        ...
        if (mContext instanceof AbsVideoPlayActivity) {
            ...
            EventBus.getDefault().post(new ShareClickEvent(mVideoBean));
        }
    }
