...
public class AbsMainHomeVideoViewHolder extends AbsMainVideoCommentViewHolder {

    public AbsMainHomeVideoViewHolder(Context context, ViewGroup parentView) {
...
//        mContext.getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    public void copyLink(VideoBean videoBean) {
        ...
        // TODO: 2020/10/19
        ClipData clipData = ClipData.newPlainText("text", CommonAppConfig.getShareLink());
//        ClipData clipData = ClipData.newPlainText("text", videoBean.getHrefW());
        mClipboardManager.setPrimaryClip(clipData);
        ToastUtil.show(com.yunbao.video.R.string.copy_success);
    }
    ...
    public void shareVideoPage(String type, VideoBean videoBean) {
        ...
        // TODO: 2020/10/19
        data.setWebUrl(CommonAppConfig.getShareLink());
...
//            }
    ...
    public void deleteVideo(final VideoBean videoBean) {
        DialogUitl.showSimpleDialog(mContext, WordUtil.getString(com.yunbao.video.R.string.confirm_delete), new DialogUitl.SimpleCallback() {
            @Override
