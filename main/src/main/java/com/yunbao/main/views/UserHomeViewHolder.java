                    ...
                    if (mCheckLivePresenter == null) {
                        mCheckLivePresenter = new LiveRoomCheckLivePresenter(mContext, new LiveRoomCheckLivePresenter.ActionListener() {
                            ...
                            public void onLiveRoomChanged(LiveBean liveBean, int liveType, int liveTypeVal, int liveSdk) {
                                ...
                                if (mFromLiveRoom) {
                                    ((UserHomeActivity) mContext).onBackPressed();
                                    EventBus.getDefault().post(new LiveRoomInfoEvent());
//                                    EventBus.getDefault().post(new LiveRoomChangeEvent(liveBean, liveType, liveTypeVal));
                                    ...
                                    mainRecommendBean.setUid(liveBean.getUid());
                                    mainRecommendBean.setPull(liveBean.getPull());
                                    mainRecommendBean.setTitle(liveBean.getTitle());
                                    mainRecommendBean.setAvatar(liveBean.getAvatar());
                                    mainRecommendBean.setAvatar_thumb(liveBean.getAvatarThumb());
                                    mainRecommendBean.setNums(liveBean.getNums());
                                    mainRecommendBean.setGoodnum(liveBean.getGoodNum());
                                    mainRecommendBean.setCity(liveBean.getCity());
                                    mainRecommendBean.setStream(liveBean.getStream());
                                    mainRecommendBean.setLevel_anchor(String.valueOf(liveBean.getLevelAnchor()));
                                    mainRecommendBean.setType(String.valueOf(liveBean.getType()));
                                    mainRecommendBean.setDistance(String.valueOf(liveBean.getDistance()));
                                    mainRecommendBean.setUser_nicename(String.valueOf(liveBean.getUserNiceName()));
                                    mainRecommendBean.setMatch_id(liveBean.getMatch_id());
                                    mainRecommendBean.setLiveclassid(liveBean.getLiveclassid());
...
//                                    LiveGameActivity.forward(mContext, liveBean, liveType, liveTypeVal, "", 0, liveSdk);
                                }
                            }
                        });
                    }
