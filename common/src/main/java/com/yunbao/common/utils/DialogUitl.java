...
public class DialogUitl {
     ...
     * 用于网络请求等耗时操作的LoadingDialog
     */
    public static Dialog loadingDialog(Context context, String text, boolean light) {
        Dialog dialog = new Dialog(context, light ? R.style.dialog2 : R.style.dialog);
        dialog.setContentView(R.layout.dialog_loading);
    ...
    public static Dialog loadingDialog(Context context, boolean bgLight) {
        return loadingDialog(context, "", bgLight);
    }
    ...
    public static void showSimpleTipDialog(Context context, String title, String content, boolean dark, boolean showConfirm, boolean cancelable, boolean canceledOnTouchOutside) {
        final Dialog dialog = new Dialog(context, dark ? R.style.dialog : R.style.dialog2);
        dialog.setContentView(R.layout.dialog_simple_tip);
        ...
        dialog.findViewById(R.id.btn_confirm).setVisibility(showConfirm ? View.VISIBLE : View.GONE);
    ...
    public static void showLogoTipDialog(Context context, String title, String content, boolean dark, boolean showConfirm, boolean cancelable, boolean canceledOnTouchOutside) {
        final Dialog dialog = new Dialog(context, dark ? R.style.dialog : R.style.dialog2);
        dialog.setContentView(R.layout.dialog_logo_tip);
        dialog.setCancelable(cancelable);
        dialog.setCanceledOnTouchOutside(canceledOnTouchOutside);
        if (!TextUtils.isEmpty(title)) {
            TextView titleView = (TextView) dialog.findViewById(R.id.title);
    ...
    public static void showLogoTipDialog(Context context, String title, final String content, boolean dark, boolean showConfirm, boolean cancelable, boolean canceledOnTouchOutside, final SimpleCallback callback) {
        final Dialog dialog = new Dialog(context, dark ? R.style.dialog : R.style.dialog2);
        dialog.setContentView(R.layout.dialog_logo_tip);
        dialog.setCancelable(cancelable);
        dialog.setCanceledOnTouchOutside(canceledOnTouchOutside);
     ...
     * @param callback
     */
    public static void showLiveManageDialog(Context context, final LiveMangeDialogCallback callback) {
        final Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_live_manage);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
        Window window = dialog.getWindow();
        window.setWindowAnimations(R.style.bottomToTopAnim);
        ...
        dialog.findViewById(R.id.common_tv_set_manage).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onSetManage();
            }
        });

        dialog.findViewById(R.id.common_tv_manage_list).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onManageList();
            }
        });
        dialog.findViewById(R.id.common_tv_forbidden_words).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onForbiddenWords();
            }
        });
     ...
     * @param dark
     */
    public static void showLiveTipDialog(Context context, String title, String content, boolean dark) {
        final Dialog dialog = new Dialog(context, dark ? R.style.dialog : R.style.dialog2);
        dialog.setContentView(R.layout.dialog_live_simple_tip);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
        if (!TextUtils.isEmpty(title)) {
            TextView titleView = (TextView) dialog.findViewById(R.id.title);
     ...
     * @param context
     */
    public static void showLoginDialog(Context context, final LiveLoginCallback callback) {
        final Dialog dialog = new Dialog(context, R.style.dialog);
        dialog.setContentView(R.layout.dialog_live_login);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);

        dialog.findViewById(R.id.common_tv_go_to_live).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.cancel();
                callback.onGoToLiving();
            }
        });

        dialog.findViewById(R.id.common_tv_login_or_register).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onLoginOrRegister();
            }
        });
        dialog.show();
    }
    ...
    public interface LiveMangeDialogCallback {
        void onSetManage();
