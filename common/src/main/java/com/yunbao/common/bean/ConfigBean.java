...
public class ConfigBean {
    ...
    private String service_switch;//:"1",
    private String service_url;//":"http://www.baidu.com",
    private String service_jump_type;
    ...
    private String mChatAnnounce;//直播公告
    private HuaWeiCloudBean huawei;

    public List<LevelBean> level;//用户等级信息
    public List<LevelBean> levelanchor;//主播等级信息
    public List<String> sensitive_words;//关键词字典库

    // 域名
    public String domain_api_live;
    public String domain_api_sports;
    public String domain_websocket_chat;
    public String domain_websocket_match;
    public List<String> prevent_blockade_site;
    ...
    //服务协议
    private String site_user_agreement;
    ...
    @JSONField(name = "site_privacy_policy")
    public String getSite_privacy_policy() {
        return site_privacy_policy;
    }
    @JSONField(name = "site_privacy_policy")
    public void setSite_privacy_policy(String site_privacy_policy) {
        this.site_privacy_policy = site_privacy_policy;
    }
    @JSONField(name = "site_user_agreement")
    public String getSite_user_agreement() {
        return site_user_agreement;
    }
    @JSONField(name = "site_user_agreement")
    public void setSite_user_agreement(String site_user_agreement) {
        this.site_user_agreement = site_user_agreement;
    }
    ...
    @JSONField(name = "service_switch")
    public void setService_switch(String service_switch) {
    ...
    @JSONField(name = "service_jump_type")
    public String getService_jump_type() {
        return service_jump_type;
    }
    @JSONField(name = "service_jump_type")
    public void setService_jump_type(String service_jump_type) {
        this.service_jump_type = service_jump_type;
    }
    ...
    @JSONField(name = "chat_announcement")
    public String getChatAnnounce() {
        return mChatAnnounce;
    }

    @JSONField(name = "chat_announcement")
    public void setChatAnnounce(String mChatAnnounce) {
        this.mChatAnnounce = mChatAnnounce;
    }
