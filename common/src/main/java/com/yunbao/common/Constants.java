...
public class Constants {
    ...
    public static final String LIVE_MATCH_ID = "match_id";
    public static final String LIVE_RECOMMEND_DATA = "live_recommend_data";
    public static final String LIVE_MATCH_INFO = "live_match_info";
    public static final String LIVE_MATCH_SPORTS = "live_match_sports";
    public static final String LIVE_MATCH_DATA = "live_match_data";
    public static final String LIVE_MATCH_FOOTBALL_INFO = "live_match_football_info";
    public static final String LIVE_MATCH_BASKETBALL_INFO = "live_match_basketball_info";

    public static final String share_link = "https://hhzb.live";
    public static final int VIDEO_MAIN_PLAY_IN = 0;
    public static final int VIDEO_PLAY_IN = 1;
    public static final String CHAT_INIT = "init";
    public static final String CHAT_SEND_MSG = "sendMsg";
    public static final Object VIDEO_PLAY_KEY = "6n07kogtxik07eh8wyvbsdk12xtpu452";
    public static final String LIVE_APP_KEY = "02019d98d6084be641cbf67ce3aa65fc";
