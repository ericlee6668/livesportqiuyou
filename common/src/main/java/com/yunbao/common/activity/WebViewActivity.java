...
public class WebViewActivity extends AbsActivity {
    ...
    protected void main() {
        ...
        mWebView.getSettings().setJavaScriptEnabled(true);//允许JS通信
        ...
        try {
            ...
            try {
                settings.setDomStorageEnabled(true);  // 允许Html存储
            } catch (Throwable e) {
                e.printStackTrace();
            }
            settings.setLoadWithOverviewMode(true); // JS通信回调
...
//                    if (m != null) {
//                        m.invoke(mWebView.getSettings(), WebSettings.MIXED_CONTENT_ALWAYS_ALLOW);
//                    }
//
//                }
//            } catch (Exception e) {
