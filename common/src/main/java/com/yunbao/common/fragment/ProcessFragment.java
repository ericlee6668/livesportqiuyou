...
//                ToastUtil.show(R.string.permission_storage_refused);
                String forceDeniedPermissionTips = "请前往设置->应用->【" + CommonAppConfig.getInstance().getAppName() + "】->权限管理->打开文件读写权限。";
                DialogUitl.showSimpleDialog(mContext, mContext.getString(R.string.permission_storage_refused)
                        + "\n" + forceDeniedPermissionTips, new DialogUitl.SimpleCallback() {
                    @Override
