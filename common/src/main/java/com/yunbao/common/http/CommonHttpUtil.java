                    ...
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0 && info.length > 0) {
                            try {
                                ...
                                CommonAppConfig.getInstance().setHuaWei(bean.getHuawei());
                                SpUtil.getInstance().setStringValue(SpUtil.CONFIG, info[0]);
                                if (obj.containsKey("domain_api_sports")){
                                    if (!TextUtils.isEmpty(obj.getString("domain_api_sports"))){
                                        CommonAppConfigNewX.getInstanceX().addHostsX(obj.getString("domain_api_sports"));
                                    }
                                }
