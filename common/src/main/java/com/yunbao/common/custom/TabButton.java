...
public class TabButton extends LinearLayout {
    ...
    private int mTextColorBlackChecked;
    ...
    public TabButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColorBlackChecked = ta.getColor(R.styleable.TabButton_tbn_text_color_black_checked, 0);
    ...
    public void setChecked(boolean checked, int checkedPosition) {
        mChecked = checked;
        if (mDrawables != null && mDrawaleArrayLength > 0) {
            if (mChecked) {
                if (mText != null) {
                    //todo 是否选中视频
//                    mText.setTextColor(checkedPosition == 2 ? mTextColorBlackChecked : mTextColorChecked);
                    mText.setTextColor( mTextColorBlackChecked);
                }

                if (mImg != null) {
                    //todo 是否选中视频
//                    mImg.setImageDrawable(checkedPosition == 2 ? mDrawables[1] : mDrawables[0]);
