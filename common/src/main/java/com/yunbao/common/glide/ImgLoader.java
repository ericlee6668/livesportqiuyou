...
public class ImgLoader {
    ...
    public static void display(Context context, String url, ImageView imageView) {
        ...
        Glide.with(context).asDrawable().load(url).placeholder(R.mipmap.icon_image_loading).error(R.mipmap.icon_load_failed).into(imageView);
    }

    public static void displayWithActive(Context context, String url, ImageView imageView) {
        if (context == null   || imageView == null) {
            return;
        }
        Glide.with(context).asDrawable().load(url).placeholder(R.mipmap.icon_image_loading).error(R.mipmap.icon_load_failed).into(imageView);
...
//        displayWithError(context, url, imageView, R.mipmap.icon_avatar_placeholder);
        Glide.with(context).load(url).placeholder(R.mipmap.icon_default_logo).error(R.mipmap.icon_default_logo).into(imageView);
    }
